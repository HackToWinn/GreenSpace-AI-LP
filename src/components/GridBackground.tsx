...
export function GridBackgroundDemo() {
  return (
    <div className="relative flex h-[90rem] w-full items-center justify-center bg-[#E6F4EC]">
      <div
        className={cn(
          "absolute inset-0",
      ...
      <div className="relative z-20 px-32 py-8">
        ...
        <p className="text-sm text-center text-gray-600 sm:text-xl mb-8">GreenSpace empowers you to reconnect with nature through smart, eco-friendly tools — identify environment with AI, track your green habits, and live more sustainably, one step at a time.</p>
        ...
        <div className="flex justify-center items-center">
          <Image src={'/images/mockup.png'} alt="Mockup" width={940} height={940} />
        </div>
      </div>
    </div>
  );
